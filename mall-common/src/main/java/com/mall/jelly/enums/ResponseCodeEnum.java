...
public enum ResponseCodeEnum {
    ...
    /*************支付订单模块 5008XX**************/
    PAY_ORDER_NOT_EXIST("500801", "未找到订单类型", "未找到订单类型", "未找到订单类型", "未找到订单类型"),
    PAY_SUCCESS("500802", "已支付", "已支付", "已支付", "已支付"),
    PAY_ALI_ERROR("500803", "请求支付客户端异常", "请求支付客户端异常", "请求支付客户端异常", "请求支付客户端异常"),
    PAY_WECAHT_PAY_FAIL("500804", "微信下单失败", "微信下单失败", "微信下单失败", "微信下单失败"),
    PAY_INVALID_SIGN_ERROR("500805", "无效的签名异常", "无效的签名异常", "无效的签名异常", "无效的签名异常"),
    PAY_INVALID_ORDER_PARAM("500806", "无效的订单参数", "无效的订单参数", "无效的订单参数", "无效的订单参数"),
